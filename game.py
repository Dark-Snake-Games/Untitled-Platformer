...
def main():
  ...
  floor_map = TileMap(2, tile_size=Vector2(32, 16))
  floating_tile = Tile(floor_map, 2, texture="assets/floating_tile.png")
  floor_map.add_tile(floating_tile, "assets/floating_tile.png", Vector2(0, 44))
  #floor = Rect2D(2, Vector2(0, 660), (255, 0, 0), Vector2(1280, 720))
  player = Player(position=Vector2(100, 150))
  player.init(window)
  text.init(window)
  floor_map.init(window)
  #floor.init(window)
  bg.init(window)
